...
Manage your carCards, routes and tickets in an intuitive way.
...
You can unlock the carCards panel using the switch on the bottom, to manually modify the numbers of carCards.
To add (remove) a carCard of an individual color, tap (long press) the corresponding tile.
### Points
Show detailed calculations of points.
#### Draw train car carCards
You can draw new train car carCards here. Add carCard by taping it or remove by long pressing.
Accept your choice by pressing green button or reset the carCards set by pressing red button.
#### Routes
Show claimed routes. You can unlock the routes list and remove the route by long pressing it.
To claim a new one press the "Claim a route" button. First choose cities names. Then select proper train car carCards.
Claim the route by pressing green button or reset the carCards set by pressing red button.
#### Destination tickets
...
To build a new one press the "Build a new station" button. First choose cities names. Then select proper car carCards.
Build the station by pressing green button or reset the carCards set by pressing red button.
#### Warehouse
(Only available in some games) Pick train car carCards from a warehouse.
Add carCard by taping it or remove by long pressing.
Accept your choice by pressing green button or reset the carCards set by pressing red button.
#### Ticket Decks
